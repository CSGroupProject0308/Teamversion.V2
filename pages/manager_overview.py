...
from db.db_functions_trips import create_trip_dropdown, del_trip_dropdown, create_trip_table, show_trip_table, create_trip_users_table, interactive_trip_table, trip_list_view
